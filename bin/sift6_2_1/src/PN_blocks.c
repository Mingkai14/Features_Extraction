...
#include "PN_blocks.h"
#include "PN_convert.c" /* so that information_per_residue can still operate on 
			wide blocks */
...
{
	Matrix* matrix;
	double ln2, e, r, hmax, totalweight, dtemp, totalr;
...
/*	printf("%d identical %d aligned\n", identical, alignment_length); */
	seqs[i]->undefined = (double) identical/ (double)alignment_length * 100;
