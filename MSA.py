...
data_list=[]
backup_lines=[]
def Prepare_Blast_Files(table_path,table_name,wt_pssm_path,mut_pssm_path,wt_psi_blast_path,mut_psi_blast_path,blast_db_path,blast_db_name):
    ...
    for data in data_list:
        ...
        if wt_pdb_name in wt_pssm_names and wt_pdb_name in wt_psi_blast_names:
        ...
        if mut_pdb_name in mut_pssm_names and mut_pdb_name in mut_psi_blast_names:
